...
# class update(name_entry, password_entry, email_entry, amount_entry, tk.Frame):
...
#         updateframe = tk.LabelFrame(
#             topframe,
#             text="Update the data",
#         )
#         updateframe.pack(side="top", fill="both", expand=True)
...
#         name_entry.grid(row=1, column=1, columnspan=3, padx=30)
...
#         password_entry.grid(row=2, column=1, columnspan=3, padx=30)
...
#         email_entry.grid(row=3, column=1, columnspan=3, padx=30)
...
#         amount_entry.grid(row=4, column=1, columnspan=3, padx=30)
...
#                 name_entry, password_entry, email_entry, amount_entry
#             ),
#             # command=self.show_search_page,
#         )
